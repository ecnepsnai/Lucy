<?php
	...
	if(isset($_POST['submit'])){
		...
		$sql[1] = "CREATE TABLE IF NOT EXISTS `userlist` (`id` int(11) NOT NULL AUTO_INCREMENT, `name` varchar(45) NOT NULL, `email` varchar(45) NOT NULL, `password` varchar(32) NOT NULL, `salt` tinyint(2) NOT NULL, `pwd_reset` tinyint(1) NOT NULL, `type` enum('Admin','Agent','Client','Bot') NOT NULL, `date_registered` date NOT NULL, PRIMARY KEY (`id`), UNIQUE KEY `email` (`email`) ) ENGINE=MyISAM DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;";
		...
		$sql[3] = "INSERT INTO `userlist` (`id`, `name`, `email`, `password`, `salt`, `pwd_reset`, `type`, `date_registered`) VALUES (1, 'Spam Bot', '', '', 0, 0, 'Bot', '0000-00-00');";
		...
		die("<meta http-equiv=\"REFRESH\" content=\"0;url=../login.php\">Redirecting...");
	}
	docWrite:
?>
<!doctype html>
...
<div id="wrapper">
	...
	<table>
		...
		<tr>
			<td><strong>Chose a Password:</strong></td>
